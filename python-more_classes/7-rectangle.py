#!/usr/bin/python3
"""
This module defines a class 'Rectangle' representing a rectangle shape with private width and height attributes, input validation, methods for calculating area and perimeter, string representations, a destructor, and class attributes to track the number of instances and the print symbol.
"""
...
class Rectangle:
    ...
    def perimeter(self):
        ...
        Returns:
            int: The perimeter of the rectangle (2 * (width + height)), or 0 if either width or height is 0.
        """
    ...
    def __repr__(self):
        ...
        Returns:
            str: A string that can be used to recreate the object, in the format `Rectangle(width, height)`.
        """
